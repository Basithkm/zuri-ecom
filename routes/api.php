...
Route::namespace('')->group(function () {
    Route::get('push-order/{id}', 'App\Http\Controllers\Api\APIController@PushOrder');
});
...
Route::group(['prefix' => 'v2', 'middleware' => ['app_language']], function () {
    ...
    Route::get('filter/attributes', 'App\Http\Controllers\Api\V2\FilterController@attributes');
    ...
    Route::get('products/new', 'App\Http\Controllers\Api\V2\ProductController@homeNew')->name('api.products.new');
    ...
    Route::get('products/festive-collection', 'App\Http\Controllers\Api\V2\ProductController@festiveCollection');
    Route::get('products/custom','App\Http\Controllers\Api\V2\ProductController@custom');
    ...
    // download invoice
    Route::get('invoice/{order_id}', 'App\Http\Controllers\Api\V2\InvoiceController@invoice_download')->name('api.invoice.download')->middleware('auth:sanctum');
    
     Route::get('blogs','App\Http\Controllers\Api\V2\BlogController@index');
     Route::get('measurements','App\Http\controllers\Api\V2\productController@getMeasurements');
