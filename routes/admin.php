...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin', 'prevent-back-history']], function() {
    ...
    Route::controller(ProductController::class)->group(function () {
        ...
        Route::post('/products/cash_on_delivery','updateCashOnDelivery')->name('products.cash_on_delivery');
        Route::post('/products/casual_collection','updatecasual_collection')->name('products.casual_collection');

        Route::post('/products/new_arrivals','updatenew_arrivals')->name('products.new_arrivals');
        
        Route::post('/products/custom','update_custom')->name('products.update_custom');


        Route::post('/products/festive_collections','updateFestiveCollection')->name('products.updateFestiveCollection');
        Route::post('/products/best_seller','updateBestDSeller')->name('products.updateBestSeller');
    ...
    Route::controller(CustomerController::class)->group(function () {
        ...
        Route::post('/customers/update/{user}','update')->name('customers.update');
    });
    ...
    Route::controller(OrderController::class)->group(function () {
        ...
        Route::post('/custom-popup', 'custom_popup')->name('order.custom_popup');

        Route::post('/pdf-download-custom', 'custom_pdf_download')->name('pdf-download.custom');


        

        // Route::get('/custom/popup/{id}', 'custom_popup')->name('custom.popup');
    ...
    // Route::post('/custom-popup', 'OrderController@showcustom')->name('custom.popup');

    
    // Route::get('/get-product-details/{id}',  [OrderController::class, 'getProductDetails'])->name('get.product.details');
    ...
    Route::controller(ReportController::class)->group(function () {
        ...
        Route::get('pdf-download','in_house_sale_report_pdf_download')->name('pdf-download.index');
        Route::get('export', 'in_house_sale_report_excel')->name('in_house_report_excel.index');
        Route::get('/stock-report','stock_report_pdf')->name('stock_report.download');
        Route::get('/wishlist-report', 'wishlist_report_pdf')->name('wishlist_report.download');
        Route::get('/stock_report_excel','stock_report_excel')->name('stock_report_excel');
        Route::get('/wishlist_report_excel','wishlist_report_excel')->name('wishlist_report_excel');
        Route::get('/sales-report', 'sales_report')->name('sales-report.index');
        Route::get('/product_type-report','product_type_report')->name('product_type_report.index');
        Route::get('/sales_report-pdf','sales_report_pdf')->name('sales_report.download');
        Route::get('/sales_report_excel','sales_report_excel')->name('sales_report_excel');
        Route::get('/product_type_report-pdf','product_type_report_download')->name('product_type_report');
        Route::get('/product_type_report_excel','product_type_report_excel')->name('product_type_report_excel');
        Route::get('/return_report','return_report')->name('return_report');

        Route::get('/return_report-pdf','return_report_pdf')->name('return_report.download');
        Route::get('/return_report_excel','return_report_excel')->name('return_report_excel');
       
    });

     //Banner
     Route::controller(BannerController::class)->group(function () {
        Route::get('/home_slide', 'home_slide')->name('home_slide.index');
        Route::post('/home_slide/store/', 'store')->name('home_slide.store');
        Route::get('/banners', 'banners')->name('banners.index');
        Route::get('/banners/edit/{id}','banners_edit')->name('banners.edit');
        Route::post('/banners/update/{banner}','update')->name('banners.update');
        Route::get('/banners/{id}', 'delete')->name('banners.delete');
        Route::get('/home_section3', 'home_section3')->name('home_section3.index');
        Route::post('/store_home3', 'store_home3')->name('store_home3');
        Route::get('/home_section4', 'home_section4')->name('home_section4.index');
        Route::post('/store_home4','store_home4')->name('store_home4');
        Route::get('home_section2','home_section2')->name('home_section2.index');
        Route::post('/store_home2','store_home2')->name('store_home2');
        Route::get('/home_section2_edit/{id}','home_section2_edit')->name('home_section2_edit');
        Route::post('/update_home2/{banner}','update_home2')->name('update_home2');
    });
