...

{
    ...
    public function create()
    {
        ...
        // $newProductCode = 'ZP100';


       
    
        // if ($latestProduct) {
        //     $latestCode = $latestProduct->zp_code;
        //     $codeParts = explode('ZP', $latestCode);

            
    
        //     if (count($codeParts) == 2) {
        //         $lastCode = intval($codeParts[1]);
        //         $newProductCode = 'ZP' . ($lastCode + 1);
        //     }
        // }
...

    {
        ...
        $request->merge(['weight' => $request->input('weight')]);
        ...
        //product type
        $request->product_type = $product->product_id;
    ...
    public function duplicate(Request $request, $id)
    {
     ...
     if ($product) {
        ...
        $product_new->zp_code = $newProductCode;
        $product_new->save();
    ...
    public function updateBestDSeller(Request $request)
    {
        $product = Product::findOrFail($request->id);
    ...
    public function updatecasual_collection(Request $request)
    {
        $product = Product::findOrFail($request->id);
        $product->casual_collection = $request->status;
        if ($product->save()) {
            Artisan::call('view:clear');
            Artisan::call('cache:clear');
            return 1;
    ...
    public function updatenew_arrivals(Request $request)
    {
        $product = Product::findOrFail($request->id);
        $product->new_arrivals = $request->status;
        if ($product->save()) {
            Artisan::call('view:clear');
            Artisan::call('cache:clear');
            return 1;
    ...
    public function updateFestiveCollection(Request $request)
    {
        $product = Product::findOrFail($request->id);
        $product->festive_collection = $request->status;
        if ($product->save()) {
            Artisan::call('view:clear');
            Artisan::call('cache:clear');
            return 1;
