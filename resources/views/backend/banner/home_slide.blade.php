...
<div class="row">
    <div class="col-xl-10 mx-auto">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('home_slide.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                     ...
                     <div class="row gutters-5">
                        ...
                        <label for="">Url</label>
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="url(https:)" name="home_slider_links[]" required>
                                    </div>
                        </div>
                        </div>
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <div class="input-group" data-type="image">
                                                    ...
                                                    <input type="hidden" name="image[]" class="selected-files" value="{{ json_decode(get_setting('home_slider_images'), true)[$key] }}" required>
                                                </div>
