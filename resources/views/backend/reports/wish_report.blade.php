                        ...
                        <div class="col-md-2">
                         ...
                         <div class="dropdown">
                           ...
                           <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                             <a href="{{ route('wishlist_report.download') }}" type="button" class="btn btn-icon btn-light d-flex justify-content-between" style="width:65% !important;">pdf<i class="las la-print"></i></a>
                              <a href="{{ route('wishlist_report_excel') }}" type="button" class="btn btn-icon btn-light d-flex justify-content-between" style="width:65% !important;">Excel<i class="las la-file-excel"></i></a>
                           </div>
                         </div>
