		...
		<div style="background: #eceff4;padding: 1rem;">
			<table>
				<tr>
					...
					<td style="font-size: 1.5rem;" class="text-right strong"><b>{{  translate('INVOICE') }}</b></td>
				</tr>
			</table>
			<table>
				<tr>
				...
				<tr>
					<td class="gry-color small">{{ get_setting('place') }}</td>
					<td class="gry-color small"></td>
			...
			<table class="padding text-left small border-bottom">
				<thead>
	                <tr class="gry-color" style="background: #eceff4;">
						...
						<!-- <th width="15%" class="text-left">{{ translate('Courier Partner') }}</th> -->
