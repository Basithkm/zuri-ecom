                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            <!-- @can('in_house_product_sale_report') -->
                                ...
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('home_slide.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['home_slide.index'])}}">
                                        <span class="aiz-side-nav-text">{{ translate('Home Slide 1') }}</span>
                                    </a>
                                </li>
                                 <li class="aiz-side-nav-item">
                                    <a href="{{ route('home_section2.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['home_slide.index'])}}">
                                        <span class="aiz-side-nav-text">{{ translate('Home section 2') }}</span>
                                    </a>
                                </li>
                                 <li class="aiz-side-nav-item">
                                    <a href="{{ route('home_section3.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['home_slide.index'])}}">
                                        <span class="aiz-side-nav-text">{{ translate('Home section 3') }}</span>
                                    </a>
                                </li>
                                 <li class="aiz-side-nav-item">
                                    <a href="{{ route('home_section4.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['home_slide.index'])}}">
                                        <span class="aiz-side-nav-text">{{ translate('Home section 4') }}</span>
                                    </a>
                                </li>
                            <!-- @endcan -->
                        </ul>
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            @can('in_house_product_sale_report')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('in_house_sale_report.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['in_house_sale_report.index'])}}">
                                        <span class="aiz-side-nav-text">{{ translate('Product wise Sale') }}</span>
                                    </a>
                                </li>
                            @endcan
                            ...
                            @endcan
                             @can('sales_report')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('sales-report.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['sales-report.index'])}} ">
                                        <span class="aiz-side-nav-text">{{ translate('Sales Report') }}</span>
                                    </a>
                                </li>
                            @endcan
                             @can('product_type_report')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('product_type_report.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['product_type_report.index'])}} ">
                                        <span class="aiz-side-nav-text">{{ translate('Product Type Report') }}</span>
                                    </a>
                                </li>
                            @endcan
                            ...
                            @can('return_report')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('return_report') }}" class="aiz-side-nav-link {{ areActiveRoutes(['return_report'])}} ">
                                        <span class="aiz-side-nav-text">{{ translate('Return Report') }}</span>
                                    </a>
                                </li>
                            @endcan 
